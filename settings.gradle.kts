...
dependencyResolutionManagement {
    versionCatalogs {
        ...
        create("libs") {
            library("packets", "com.github.retrooper:packetevents-spigot:2.4.0")
