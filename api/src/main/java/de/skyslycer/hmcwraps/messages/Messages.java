...
public enum Messages {
    ...
    COMMAND_NO_FILE("command.no-file"),
    COMMAND_BAD_FOLDER("command.bad-folder"),
    COMMAND_INVALID_FORMAT("command.invalid-format"),
    COMMAND_INVALID_CATEGORY("command.invalid-category"),
